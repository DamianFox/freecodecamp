...
var Homepage = function (_Component) {
    ...
    _createClass(Homepage, [{
        ...
        value: function getData(e) {
            ...
            fetch(wikipediaEndPoint).then(function (data) {
                return data.json();
            }).then(function (data) {
                ...
                if (objectList !== "") {
                    resultRender = Object.keys(objectList).map(function (key, index) {
                        return _react2.default.createElement(
                            "div",
                            { className: "item", key: objectList[key].pageid },
                            _react2.default.createElement(
                                "a",
                                { href: wikipediaUrl + objectList[key].pageid },
                                _react2.default.createElement(
                                    "h1",
                                    null,
                                    objectList[key].title
                                ),
                                _react2.default.createElement(
                                    "p",
                                    null,
                                    objectList[key].extract
                                )
                            )
                        );
                    });
                } else {
                    resultRender = _react2.default.createElement(
                        "div",
                ...
                _this2.setState({ search: resultRender });
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "a",
                    { className: "random", href: "https://en.wikipedia.org/wiki/Special:Random", target: "_blank" },
                    "Click here for a random article"
                ),
                _react2.default.createElement(
                    "form",
                    { onSubmit: this.getData },
                    _react2.default.createElement("input", { type: "text", id: "search", name: "search", className: "form-control", placeholder: "Search Wikipedia", autoComplete: "off" })
                ),
                _react2.default.createElement(
                    "div",
                    { className: "items" },
...
_reactDom2.default.render(_react2.default.createElement(Homepage, null), app);
